...
<main class="main">
    ...
    <div class="site-breadcrumb innerPageBannerContainer">
        <div class="container">
            <h2 class="breadcrumb-title">Exhibition Space Registration</h2>
            <ul class="breadcrumb-menu">
                <li><a href="index.html">Home</a></li>
                <li class="active">Exhibition Space Registration</li>
            </ul>
        </div>
    </div>
    <!-- breadcrumb end -->
                    ...
                    <div class="col-lg-7">
                        <div class="contact-form">
                            <div class="contact-form-header">
                                <h2>Exhibition Space Registration</h2>
                            </div>
                            <form method="post" action="/eventu/assets/php/contact.php" id="contact-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="jobFunction"
                                                placeholder="Job Function" required>
                                        </div>
                                    </div>
                                </div>
